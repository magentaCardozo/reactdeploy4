...
`,Ry=({className:e})=>u.jsxs("div",{className:e,children:[u.jsx("div",{className:"first",children:u.jsx("div",{className:"first-container",children:u.jsx(zy,{})})}),u.jsx("div",{className:"second",children:u.jsx("div",{className:"second-container",children:u.jsx(Iy,{})})}),u.jsx("div",{className:"third",children:u.jsx("div",{className:"third-container",children:u.jsx(_y,{})})})]}),Va=({image:e,text:t,style:n})=>{const r={position:"Absolute",fontFamily:"audrey",fontSize:"inherit",fontWeight:"bolder",color:"white",textAlign:"center"},i={position:"relative",display:"flex",fontSize:"inherit",alignItems:"center",justifyContent:"center",width:"100%",height:"100%",backgroundColor:"#DADAD6",boxShadow:"-10px 10px 20px #000000",marginBottom:"3rem"};return u.jsx("div",{style:{...i,...n},children:u.jsx("div",{className:"px-4",style:r,children:e?u.jsx("img",{src:e,alt:""}):u.jsx("div",{className:"spanText",children:t})})})},Oy=re(py)`
width: 100%;
height: 100%;
    margin-top:3.5rem;
    display: grid;
...
`,$y="/reactdeploy4/assets/img_5-R_nZnJim.png",by="/reactdeploy4/assets/img_6-ej2dVkQl.png",Uy=({className:e})=>u.jsxs("div",{className:e,children:[u.jsx("div",{className:"first",children:u.jsx(Va,{image:by})}),u.jsx("div",{className:"second",children:u.jsx(Va,{text:"Livraison gratuite à partir de 50$",style:{backgroundColor:Z.FIFTH}})}),u.jsx("div",{className:"third",children:u.jsx(Va,{image:$y})})]}),By=re(Uy)`
...
`,tx=({className:e})=>u.jsx("div",{className:e,children:u.jsx("img",{src:Qy,className:"w-100",alt:""})});re(tx)`
...
`;const Ox=()=>{const{pathname:e}=un();return E.useEffect(()=>{window.scrollTo({top:0,behavior:"instant"})},[e]),u.jsxs("div",{className:"home-screen",style:{backgroundColor:Z.MAIN},children:[u.jsx(Sh,{}),u.jsx(Rx,{})]})},Ax="/reactdeploy4/assets/jpg_1-7lt4SJ85.jpg",Fx=({className:e})=>u.jsx("div",{className:e,children:u.jsxs("div",{className:"first",children:[u.jsx("div",{className:"img-content",children:u.jsx("img",{src:Ax,width:"100%",alt:"",srcset:""})}),u.jsx("div",{className:"text",children:"Livraison où que vous soyez à Kinshasa"})]})}),$x=re(Fx)`
width:100%;
height:40vh;
margin-top:3rem;
position: relative;
...
`,bx="/reactdeploy4/assets/jpg_2-1pXFpQc3.jpg",Ux=({className:e})=>u.jsx("div",{className:e,children:u.jsx("div",{className:"image"})}),Ie=re(Ux)`
width:calc(25%);
...
`,Bx=({className:e})=>u.jsxs("div",{className:e,children:[u.jsx("div",{className:"first",children:u.jsx("div",{className:"image",children:u.jsx("img",{src:bx,alt:""})})}),u.jsxs("div",{className:"second",children:[u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{}),u.jsx(Ie,{})]})]}),Hx=re(Bx)`
width:100%;
min-height:100vh;
margin-bottom:1rem;
height:fit-content;
...
`,Kx=({className:e})=>{const{pathname:t}=un(),[n,r]=E.useState(0),{articles:i}=E.useContext(mo),{id:o}=Ju(),l=i.filter(x=>x.id===Number(o))[0];if(!l)return u.jsx(Rl,{});const{name:a,image:s,price:c,pricePromo:d,longName:p,slug:m}=l;return E.useEffect(()=>{window.scrollTo({top:0,behavior:"instant"}),r(0)},[t]),u.jsxs("div",{className:`${e} `,children:[u.jsx("div",{children:l.image.map((x,S,w)=>u.jsx("div",{className:" imageBox",onClick:()=>r(S),children:u.jsx("img",{src:x,alt:"",width:"100%",height:"100%"})},S))}),u.jsxs("div",{children:[u.jsx("div",{className:"_button",children:u.jsxs("a",{target:"_blank",href:`https://wa.me/243840199718?text=Bonjour,%20je%20suis%20interessé%20par%20le%20produit%20${a}.%20Merci`,children:["Acheter maintenant",u.jsx("span",{className:"span1",children:u.jsxs("span",{children:["Discuter avec nous sur whatsapp",u.jsx("span",{children:u.jsx(qy,{})})]})})]})}),u.jsxs("span",{className:"price",children:[c," ",u.jsx("span",{className:"dollarSign",children:"$"})," ",!d||u.jsxs("span",{className:"promo-1",children:[d," ",u.jsx("span",{className:"dollarSign2",children:"$"})]})," "]}),u.jsxs("span",{className:"maincolor",children:[a," "]}),u.jsxs("span",{className:"maincolor",children:[" ",p," "]}),u.jsxs("span",{className:"maincolor slug",children:[" ",m," "]})]})]})},Gx=re(Kx)`
background-color :${Z.MAIN};
padding-bottom: 3rem;
padding-top : 3.4rem;
...
`,qx=({className:e})=>{const{pathname:t}=un();E.useEffect(()=>{window.scrollTo({top:0,behavior:"instant"})},[t]);const{information:n}=Ju(),r=Tx.filter(i=>i.title===n)[0];return u.jsxs("div",{className:`${e}`,children:[u.jsx("div",{children:r.title2}),u.jsx("div",{children:r.slug})]})},Zx=re(qx)`
...
`,Xx=Pg(Vs(u.jsxs(Vt,{path:"/",element:u.jsx(Px,{}),children:[u.jsx(Vt,{index:!0,element:u.jsx(Ox,{})}),u.jsx(Vt,{path:Ae.Products,element:u.jsx(Yx,{})}),u.jsx(Vt,{path:`${Ae.Categorie}:categorie`,element:u.jsx(Qx,{})}),u.jsx(Vt,{path:`${Ae.Details}:id`,element:u.jsx(Gx,{})}),u.jsx(Vt,{path:`${Ae.Info}:information`,element:u.jsx(Zx,{})}),u.jsx(Vt,{path:"/error",element:u.jsx(Rl,{})}),u.jsx(Vt,{path:"*",element:u.jsx(Rl,{})})]})));Ga.createRoot(document.getElementById("root")).render(u.jsx(qe.StrictMode,{children:u.jsx(bg,{router:Xx})}));
