...
`;const My=({className:e})=>{const[t,n]=E.useState(!1);function r(){n(i=>!i),console.log(t)}return u.jsx("div",{className:e,children:u.jsxs("div",{className:t&&"menu-down",onClick:()=>r(),children:[u.jsx("span",{}),u.jsx("span",{}),u.jsx("span",{}),u.jsx("div",{children:u.jsxs("ul",{children:[u.jsx("li",{children:u.jsx(Dt,{to:`${We.Categorie}cosmetique`,children:"Cosmetique"})}),u.jsx("li",{children:u.jsx(Dt,{to:`${We.Categorie}telephone`,children:"Télephone"})}),u.jsx("li",{children:u.jsx(Dt,{to:`${We.Categorie}montre`,children:"Montres"})}),u.jsx("li",{children:u.jsx(Dt,{to:`${We.Categorie}accessoire`,children:"Accessoires"})}),u.jsx("li",{children:u.jsx(Dt,{to:`${We.Info}modePaiement`,children:"Mode de paiement"})}),u.jsx("li",{children:u.jsx(Dt,{to:`${We.Info}commentAcheter`,children:"Comment acheter chez nous ?"})}),u.jsx("li",{children:u.jsx(Dt,{to:`${We.Info}aPropos`,children:"A propos"})})]})})]})})},Ey=ne(My)`
        display:none;
...
`,t3=tg(zs(u.jsxs(Wt,{path:"/",element:u.jsx(_y,{}),children:[u.jsx(Wt,{index:!0,element:u.jsx($y,{})}),u.jsx(Wt,{path:We.Products,element:u.jsx(Gy,{})}),u.jsx(Wt,{path:`${We.Categorie}:categorie`,element:u.jsx(qy,{})}),u.jsx(Wt,{path:`${We.Details}:id`,element:u.jsx(Xy,{})}),u.jsx(Wt,{path:`${We.Info}:information`,element:u.jsx(e3,{})}),u.jsx(Wt,{path:"/error",element:u.jsx(kl,{})}),u.jsx(Wt,{path:"*",element:u.jsx(kl,{})})]})));Aa.createRoot(document.getElementById("root")).render(u.jsx(Ke.StrictMode,{children:u.jsx(cg,{router:t3})}));
